        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.html"> <img class="img-rounded" src="images/Webp.net-compress-image (1).jpg" alt=""> </a>
        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpeg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Enjoy your Meals with EAT EASY </h1>
                    <h3 class="font-white space-xs">WHAT CAME FIRST CHICKEN OR EGG ? I DON'T CARE I EAT BOTH</h3>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Frequently bought dishes</h2>
