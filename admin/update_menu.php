            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon -->
                        <b><img src="images/Webp.net-compress-image (1).jpg" alt="homepage" class="dark-logo" /></b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span><img src="images/Webp.net-compress-image (1).jpg" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
                <!-- End Logo -->
